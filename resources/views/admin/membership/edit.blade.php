    ...
    <div class="ad_displayDetails col-10 mt-2">
        <div class=" w-full flex justify-center items-center">
            <div class="rounded-lg shadow-md   w-full bg dark:bg-gray-800 p-5">
                ...
                <form method="POST" action={{route("admin.membership.update",['id'=>$membership->id])}} class="space-y-4">
                    @csrf
                    @method('PUT')
                    <div class="d-flex justify-between align-start mb-3">
                        <div class="col-5" >
                            <x-input-label for="membershipLevel" :value="__('Membership Label')" />
                            <x-text-input id="membershipLevel" name="membershipLevel" type="text" class="mt-1 block w-full" value="{{$membership->membershipLevel}}" />
                        ...
                        <div class="col-5">
                            ...
                            <x-text-input id="numberOfBooks"  name="numberOfBooks" type="text" class="mt-1 block w-full"  value="{{$membership->numberOfBooks}}" />
                    ...
                    <div class="d-flex justify-between align-start">
                        <div class="col-5" >
                            ...
                            <x-text-input id="price"  name="price" type="text" class="mt-1 block w-full" value="{{$membership->price}}"  />
                            <x-input-error :messages="$errors->get('price')" class="text-red-600"/>
                        </div>
                        <div class="col-5" >
                            <x-input-label for="benefit" :value="__('Benefit')" />
                            <textarea id="benefit" placeholder="Separate benefits by comma" name="benefit" type="text" class="mt-1 block w-full" >{{$membership->Extra}}</textarea>
